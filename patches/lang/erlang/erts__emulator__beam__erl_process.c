...
--- erts/emulator/beam/erl_process.c.orig	2011-05-24 11:16:43.000000000 +0000
...
@@ -5178,6 +5179,13 @@ Process *schedule(Process *p, int calls)
     int actual_reds;
     int reds;
...
@@ -6381,6 +6389,14 @@ erl_create_process(Process* parent, /* P
...
@@ -6949,6 +6965,17 @@ send_exit_signal(Process *c_p,		/* curre
...
@@ -7384,7 +7411,16 @@ erts_do_exit_process(Process* p, Eterm r
